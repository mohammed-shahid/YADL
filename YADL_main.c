...
int main(int argc, char* argv[])
{
	...
	if(!process_index)
		...
		printf("\nIn %ds, each node enters C-S average %0.2fx, %0.2fs delay (max %0.2fs) RAs: %0.1f, MCS-length:%0.2f, MCS-Qs: %0.1f, Scanned locks: %0.2f", time_horizon, average_CS, average_SPAR, max_SPAR, average_RA, average_MCS_LENGTH, total_MCS_QUEUE_NOS, average_locks_scanned);
